...
class Ui_Widget(object):
	def setupUi(self, Widget):
		...
		self.DeleteButton.setGeometry(QRect(10, 360, 171, 24))
		...
		self.groupBox_2.setGeometry(QRect(10, 390, 171, 71))
		...
		self.ProcessingButton.setGeometry(QRect(10, 470, 171, 24))
		...
		self.progressBar.setGeometry(QRect(10, 500, 171, 23))
		self.progressBar.setStyleSheet(u"")
		self.progressBar.setValue(24)
		self.HelpHelp = QPushButton(Widget)
		self.HelpHelp.setObjectName(u"HelpHelp")
		self.HelpHelp.setGeometry(QRect(10, 560, 171, 24))
		...
		self.SaveButton.setGeometry(QRect(10, 530, 171, 24))
		...
		self.listWidget.setGeometry(QRect(10, 70, 171, 281))
	...
	def retranslateUi(self, Widget):
		Widget.setWindowTitle(QCoreApplication.translate("Widget",
														 u"\u0421\u0438\u0431\u0438\u0440\u0441\u043a\u0438\u0439 \u0433\u043e\u0441\u0443\u0434\u0430\u0440\u0441\u0442\u0432\u0435\u043d\u043d\u044b\u0439 \u0443\u043d\u0438\u0432\u0435\u0440\u0441\u0438\u0442\u0435\u0442 \u0433\u0435\u043e\u0441\u0438\u0441\u0442\u0435\u043c \u0438 \u0442\u0435\u0445\u043d\u043e\u043b\u043e\u0433\u0438\u0439 ",
														 None))
		self.DeleteButton.setText(
			QCoreApplication.translate("Widget", u"\u0423\u0434\u0430\u043b\u0438\u0442\u044c \u0444\u0430\u0439\u043b",
									   None))
		self.groupBox_2.setTitle(
			QCoreApplication.translate("Widget", u"\u041e\u0431\u0440\u0430\u0431\u043e\u0442\u0430\u0442\u044c", None))
		...
		self.ProcessingButton.setText(
			QCoreApplication.translate("Widget", u"\u041e\u0431\u0440\u0430\u0431\u043e\u0442\u0430\u0442\u044c", None))
		self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QCoreApplication.translate("Widget",
																							   u"\u0424\u0430\u0439\u043b \u0434\u043e \u043e\u0431\u0440\u0430\u0431\u043e\u0442\u043a\u0438",
																							   None))
		self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QCoreApplication.translate("Widget",
																								 u"\u0424\u0430\u0439\u043b \u043f\u043e\u0441\u043b\u0435 \u043e\u0431\u0440\u0430\u0431\u043e\u0442\u043a\u0438",
																								 None))
		self.HelpHelp.setText(QCoreApplication.translate("Widget", u"\u0421\u043f\u0440\u0430\u0432\u043a\u0430", None))
		self.SaveButton.setText(
			QCoreApplication.translate("Widget", u"\u0421\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c", None))
		self.DownloadVideoButton.setText(QCoreApplication.translate("Widget",
																	u"\u0417\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044c \u0444\u0430\u0439\u043b",
																	None))
		self.label.setText(QCoreApplication.translate("Widget",
													  u"\u041f\u0440\u043e\u0433\u0440\u0430\u043c\u043c\u043d\u044b\u0439 \u043a\u043e\u043c\u043f\u043b\u0435\u043a\u0441 \u043e\u043f\u0440\u0435\u0434\u0435\u043b\u0435\u043d\u0438\u044f \u0434\u0435\u0444\u043e\u0440\u043c\u0430\u0446\u0438\u0439 \u0437\u0434\u0430\u043d\u0438\u0439 \u0438 \u0441\u043e\u043e\u0440\u0443\u0436\u0435\u043d\u0438\u0439 ",
													  None))
# retranslateUi
